    ...
    for file in glob.glob('data/fulltext_corpus/text*.csv'):
        ...
        for index, row in texts.iterrows():
            ...
            if len(figures) == 0:
                ...
                figures.to_csv(file.replace('fulltext_corpus/text', 'figure_corpus/figures'), mode='a', index=False, header=False)
...
# training_test_figures_texts('figure_labeled_examples.csv', 'figurescrawledData.csv', 'figuresiGEMsPDFs.csv')
